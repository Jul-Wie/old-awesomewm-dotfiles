...
return gears.table.join(
  ...
  { description = "rofi dmenu theme run", group = "Awesome" }
  ),
  awful.key(
    { modkey },
    "c",
...
--        function(stdout)
--          awful.spawn.easy_async_with_shell("xfpm-power-backlight-helper --set-brightness " .. tostring(tonumber(stdout) + BACKLIGHT_SEPS), function(stdout)
--
--          end)
...
--      )
  ...
  awful.key(
   ...
   --   awful.spawn.easy_async_with_shell(
     --   "xfpm-power-backlight-helper --get-brightness",
      --  function(stdout)
     --     awful.spawn.easy_async_with_shell("xfpm-power-backlight-helper --set-brightness " .. tostring(tonumber(stdout) - BACKLIGHT_SEPS), function(stdou2)
--
  --        end)
    --      awesome.emit_signal("module::brightness_osd:show", true)
      --    awesome.emit_signal("module::brightness_slider:update")
