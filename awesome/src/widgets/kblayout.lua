...
return function(s)
        ...
        awful.spawn.easy_async_with_shell(
          ...
          function(stdout)
            ...
            if kb_layout_item.keymap == layout then
              ...
              kb_layout_item:get_children_by_id("background2")[1].fg = color["White"]
              kb_layout_item:get_children_by_id("background1")[1].fg = color["White"]
            else
              kb_layout_item.bg = color["White"]
  ...
  -- Signals
  Hover_signal(kblayout_widget, color["Green200"], color["White"])
