...
return function(s)
    ...
    awful.spawn.easy_async_with_shell(
      ...
      function(stdout)
        ...
        audio_widget.container.audio_layout.icon_margin.icon_layout.icon:set_image(
          gears.color.recolor_image(icon .. ".svg", color["White"]))
    ...
    awful.spawn.easy_async_with_shell(
      ...
      function(stdout)
        if stdout:match("yes") then
          ...
          audio_widget.container.audio_layout.icon_margin.icon_layout.icon:set_image(
            gears.color.recolor_image(icondir .. "volume-mute" .. ".svg", color["White"]))
  ...
  -- Signals
  Hover_signal(audio_widget, color["Yellow200"], color["White"])
