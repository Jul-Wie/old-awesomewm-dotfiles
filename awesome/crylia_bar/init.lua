...
-- e.g. 1 would be the primary screen and 2 the secondary screen.
  ...
  if s.index == 1 then
    --.systray = require("src.widgets.systray")(s)
    --s.cpu_usage = require("src.widgets.cpu_info")("usage")
    --s.cpu_temp = require("src.widgets.wcpu_info")("temp")
    ...
    require("crylia_bar.right_bar")(s, { s.clock, s.date, s.battery, s.audio, s.systray, s.powerbutton })
